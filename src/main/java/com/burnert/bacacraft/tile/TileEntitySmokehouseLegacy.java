...
import static com.burnert.bacacraft.block.BlockSmokehouseLegacy.isBlockTopObstructed;

public class TileEntitySmokehouseLegacy extends TileEntityCore implements ITickable, ISidedInventoryAdvanced {
...
//	private static final int[] SLOTS_TOP = new int[]{};
	...
	public TileEntitySmokehouseLegacy() {
		super();
	...
	public void readFromNBT(NBTTagCompound compound) {
		...
		this.currentItemBurnTime = TileEntitySmokehouseLegacy.getItemBurnTime(smokehouseItemStacks.get(0));
	...
	public void update() {
		...
		if (!this.world.isRemote) {
			...
			if (wasBurning != this.isBurning()) {
				dirty = true;
				BlockSmokehouseLegacy.setState(this.isBurning(), this.world, this.pos);
			}
		}
		if (dirty) {
			this.markDirty();
